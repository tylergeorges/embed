import { MessageContainerStyle } from "@ui/Messages/Message/elements";
    ...
    <MessageContainerStyle.Base>
      <MessageContainerStyle.Buttons className="buttons">
        {props.buttons.map(option => (
          <Tooltip overlay={option.actionDescription} placement="top" key={option.actionDescription}>
            <MessageContainerStyle.Button onClick={option.onClick}>
              <img src={option.icon} alt={option.actionDescription} width={20} />
