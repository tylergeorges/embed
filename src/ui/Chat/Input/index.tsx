  ...
  render() {
    ...
    return (
      <Root>
        ...
        {settingsStore.sendButton && <SendButtonContainer className="send-button-container">
          <SendButton onClick={this.submit} disabled={this.textarea?.value.length === 0} className="send-button">
