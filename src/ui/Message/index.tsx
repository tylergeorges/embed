              ...
              {repliedMessage ? 
                ...
                : firstMessage.interaction ? 
                  <RepliedMessage className="replied-message">
                    ...
                    <InteractionText className="interaction">used <Command className="command">{firstMessage.type === MessageType.ApplicationCommand && '/'}{firstMessage.interaction.name}</Command></InteractionText>
                  </RepliedMessage>
                :
                <RepliedMessage className="replied-message">
                  <UnknownReplyIconWrapper>
